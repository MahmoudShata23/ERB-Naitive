    ...
    return (
      ...
      p
        ...
        : Object.assign(
            {},
            o,
            (((t = {})[v] = a ? u + "px" : ""), (t[h] = d ? e + "px" : ""), (t.transform = ""), t)
          )
    );
  }
  function H(e) {
              ...
              "auto" === x(n)
                ? (function (e, t) {
                    ...
                    var p = i.reduce(function (t, i) {
                      return (
                        (t[i] = A(e, { placement: i, boundary: n, rootBoundary: o, padding: r })[
                          x(i)
                        ]),
                        t
                      );
    ...
    ne = {
      ...
      fn: function (e) {
        ...
        var u = t.rects.reference,
          m = t.rects.popper,
          h =
            "function" == typeof s ? s(Object.assign({}, t.rects, { placement: t.placement })) : s;
        if (((s = { x: 0, y: 0 }), a)) {
          if (r || i) {
            var v = "y" === l ? "top" : "left",
              g = "y" === l ? "bottom" : "right",
