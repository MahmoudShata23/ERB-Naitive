...
// $(".text-truncate1").click(function () {
//   $(".notification-content1").toggle(300);
// });
// $(".text-truncate2").click(function () {
//   $(".notification-content2").toggle(300); 
// });
// $(".text-truncate3").click(function () {
//   $(".notification-content3").toggle(300);
// });
// $(".text-truncate4").click(function () {
//   $(".notification-content4").toggle(300);
// });
// $(".text-truncate5").click(function () {
//   $(".notification-content5").toggle(300); 
// });
// $(".text-truncate6").click(function () {
//   $(".notification-content6").toggle(300); 
// });
